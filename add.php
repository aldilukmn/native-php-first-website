                    ...
                    <div class="card-body p-5 mb-2">
                            <div class="container">
                                <div class="row text-center mb-3">
                                    <h2 class="fw-bold text-uppercase">Form Pasient</h2>
                                </div>
                                <hr>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 form-group">
                                            ...
                                            <div class="col-md-6 form-group">
                                                ...
                                                <input type="text" name="indication" id="indication" class="form-control" value="" required >
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row mt-3">
